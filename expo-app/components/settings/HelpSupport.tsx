...
function SearchIcon() {
  const t = useTheme();
  return (
    <Svg width={18} height={18} viewBox="0 0 24 24" fill="none" stroke={t.textFaint} strokeWidth={2}>
...
function SparklesIcon() {
  const t = useTheme();
  return (
    <Svg width={24} height={24} viewBox="0 0 24 24" fill="none" stroke={t.textPrimary} strokeWidth={2}>
  ...
  return (
    <SettingsPage title="Help & Support" onBack={onBack}>
      ...
      <TouchableOpacity style={styles.faithCard} activeOpacity={0.9} onPress={handleTalkToFaith}>
        <LinearGradient
          colors={t.gradients.avatarReversed}
          start={{ x: 0, y: 0 }}
          end={{ x: 1, y: 1 }}
